    ...
    const fetchData = async () => {
        ...
        try {
            ...
            if (props && Array.isArray(props)) {
              setFeaturedProperties(props.slice(0, 9));
            }
            ...
            console.warn("API offline or unreachable, showing empty states.");
        } finally {
            setIsLoading(false);
        }
    };
            ...
            <div className="max-w-3xl w-full">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-1 mb-6 rounded-full bg-white/10 backdrop-blur-md border border-white/20">
                        <span className="w-2 h-2 rounded-full bg-dies-red animate-pulse"></span>
                        <h2 className="text-white font-black tracking-widest uppercase text-[10px] md:text-xs">Dies Gayrimenkul</h2>
                    </div>
                    ...
                    <p className="text-slate-100 text-base md:text-xl font-bold mb-10 max-w-2xl leading-relaxed drop-shadow-md">
                ...
                <MotionForm 
                    ...
                    className="bg-white p-2 rounded-2xl md:rounded-full shadow-2xl flex flex-col md:flex-row gap-2 w-full max-w-2xl"
                >
                    <div className="flex-grow px-4 md:px-6 py-3 md:py-4 flex items-center w-full">
                        ...
                        <input 
                            ...
                            className="bg-transparent border-none outline-none text-dies-dark placeholder-gray-400 w-full min-w-0 font-bold text-sm md:text-base"
                        />
                    </div>
                    <button 
                        type="submit"
                        className="bg-dies-red hover:bg-red-700 text-white px-8 md:px-10 py-3 md:py-4 rounded-full font-black transition-all shadow-lg uppercase tracking-wide text-sm w-full md:w-auto shrink-0"
                    >
                        ARA
                    </button>
                </MotionForm>
        ...
        <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-end mb-8 md:mb-12 gap-4">
                <div className="w-full md:w-auto">
                    <h2 className="text-3xl md:text-4xl font-black text-dies-dark mb-3">
                        Öne Çıkan <span className="text-dies-blue">Fırsatlar</span>
                    </h2>
                    <p className="text-dies-slate text-base md:text-lg font-medium">Portföyümüzdeki en güncel ve seçkin ilanlar.</p>
                </div>
                
                <Link to="/ilanlar" className="w-full md:w-auto justify-center px-6 py-3 bg-white text-dies-blue font-black rounded-full shadow-soft border border-gray-100 hover:shadow-md hover:text-dies-red transition-all flex items-center gap-2">
            ...
            {isLoading ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-dashed border-gray-200 text-center">
                    ...
                    <p className="text-gray-400 font-medium">Yeni fırsatlar çok yakında burada olacak.</p>
                </div>
            )}
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                {[
                    ...
                    <div key={idx} className="group p-6 md:p-8 rounded-2xl bg-dies-light hover:bg-white border border-transparent hover:border-gray-100 hover:shadow-xl transition-all duration-300">
                        ...
                        <h3 className="text-xl md:text-2xl font-black text-dies-dark mb-3">{item.title}</h3>
                        <p className="text-dies-slate font-medium leading-relaxed text-sm md:text-base">{item.desc}</p>
                    </div>
                ))}
            </div>
        </div>
          ...
          <section className="py-16 md:py-24 bg-dies-blue text-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                 <div className="text-center mb-12 md:mb-16">
                     <h2 className="text-3xl md:text-5xl font-black mb-4">Kurucu Ortaklar</h2>
                     <p className="text-slate-300 text-base md:text-lg font-medium max-w-2xl mx-auto">Sektörün öncü isimleri ile güvenilir yatırımın adresi.</p>
                 </div>
                        ...
                        <Link to={`/danisman/${founder.id}`} key={founder.id} className="w-full md:w-auto">
                            ...
                            >
                                ...
                                <div className="text-center">
                                    <h3 className="text-xl md:text-2xl font-black text-white group-hover:text-dies-dark mb-1 transition-colors whitespace-nowrap overflow-hidden text-ellipsis px-1">{founder.name}</h3>
                                    <p className="text-dies-red font-black uppercase tracking-widest text-[10px] mb-6 bg-white/10 inline-block px-3 py-1 rounded-full group-hover:bg-dies-red/10 group-hover:text-dies-red transition-colors">{founder.role}</p>
        ...
        <div className="container mx-auto px-4">
            <div className="bg-dies-light rounded-3xl p-8 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10 shadow-inner border border-gray-100 text-center md:text-left">
                <div className="max-w-xl">
                    <h2 className="text-3xl md:text-4xl font-black text-dies-dark mb-4">Ekibimize Katılın</h2>
                    <p className="text-dies-slate text-base md:text-lg font-medium mb-8">
